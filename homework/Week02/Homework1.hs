...
-- This version feels more like Haskell, and is nice and easy to read:
-- mkValidator () (x, y) _
--     | x == y    = True
--     | otherwise = False
--
-- This version is, it seems, better for Plutus, though:
mkValidator () (x, y) _ = traceIfFalse "Bool values don't match" (x == y)
